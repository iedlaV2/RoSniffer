...
def discover_page(parent_frame):
    ...
    discover_prev_page_button = tk.CTkButton(pagination_frame, text="Previous", command=go_to_previous_page, state="disabled",
    ...
    discover_page_info_label = tk.CTkLabel(pagination_frame, text="Page 0/0", font=tk.CTkFont(family=custom_font, size=12))
...
class App(tk.CTk):
    def __init__(self):
        ...
        button_btn = tk.CTkButton(side_frame, text="Server Search", compound="left", command=show_server_search_page,
                                  anchor="center",fg_color="transparent", text_color=("black", "white"), hover_color='royal blue',
        ...
        button_btn = tk.CTkButton(side_frame, text="Game Explorer", compound="left", command=show_discover_page,anchor="center",
                                  fg_color="transparent", text_color=("black", "white"), hover_color='royal blue',font=tk.CTkFont(family=custom_font, size=15))
        ...
        button_btn_search = tk.CTkButton(side_frame, text="Game Search", compound="left", command=show_game_search,
                                         anchor="center",fg_color="transparent", text_color=("black", "white"),
                                        hover_color='royal blue',font=tk.CTkFont(family=custom_font, size=15))
